	...
	<div class='container'>
		...
		<div id ='new4' class='main'><br><?php 
			...
			?><div class='desc'><?php  
				...
				echo "Return to <a href='?id=".$ifcProject."'>IfcProject</a>";
				// add credit
				echo "<br><br>Based on a linked ifc JSON experiment by <a href='https://github.com/janbrouwer'>Jan Brouwer.</a>";
				echo "<br><br>Code for this hack can be found on <a href='https://github.com/timmcginley/JsonLink'>GitHub.</a>";
			?></div>
		</div>
		
		<div id ='new2' class='main'><?php 
